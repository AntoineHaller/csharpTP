...
namespace Venezia.Controllers
{
    public class CarsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Mark,Model,Price,FuelTypeID,Autonomous")] Car car)
        {
            ...
            //Si l'utilisateur n'est pas connecté on enregistre pas la voiture et on redirige l'utilisateur sur la page de connexion
            if(ModelState.IsValid && !HttpContext.User.Identity.IsAuthenticated) Response.Redirect("/Identity/Account/login");
        ...
        {
            //Si l'utilisateur n'est pas connecté on enregistre pas la voiture et on redirige l'utilisateur sur la page de connexion
            if (!HttpContext.User.Identity.IsAuthenticated) Response.Redirect("/Identity/Account/login");
